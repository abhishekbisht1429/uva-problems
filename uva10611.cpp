...
int main() {
    ...
    while(q--) {
        ...
        int i1 = lower_bound(heights.begin(), heights.end(), h) - heights.begin() - 1;
        int i2 = upper_bound(heights.begin(), heights.end(), h) - heights.begin();
        
        if(i1 >= 0) cout<<heights[i1]<<" ";
        else cout<<"X ";

        if(i2<n) cout<<heights[i2];
        else cout<<"X";
        cout<<"\n";
    }
